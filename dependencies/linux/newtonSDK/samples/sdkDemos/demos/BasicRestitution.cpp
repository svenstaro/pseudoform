...
void Restitution (SceneManager& system)
{
	...
	for (int i = 0; i < zCount; i ++) {
		...
		body = CreateGenericSolid (system.m_world, &system, mass, matrix, sphSize, _SPHERE_PRIMITIVE, defaultMaterialID);
		...
		body = CreateGenericSolid (system.m_world, &system, mass, matrix, boxSize, _BOX_PRIMITIVE, defaultMaterialID);
		NewtonBodySetLinearDamping (body, 0.0f);
