...
//NewtonBody* xxx = CreateGenericSolid (system.m_world, &system, mass, baseMatrix, blockBoxSize, _SPHERE_PRIMITIVE, defaultMaterialID);
//dVector xxxx(-50, 0, 0, 0);
//NewtonBodySetOmega (xxx, &xxxx[0]);
