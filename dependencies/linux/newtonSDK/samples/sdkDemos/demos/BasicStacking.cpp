...
static void BasicCollisionStacks (SceneManager& system, NewtonCollision* collision, int high)
{
	dFloat mass;
	dFloat Ixx;
	dFloat Iyy;
...
void BasicBoxStacks (SceneManager& system)
{
	...
	collision = NewtonCreateBox (system.m_world, size.m_x, size.m_y, size.m_z, 0, NULL); 
